...
e = Event.create({
  ...
  published_at: DateTime.parse('Sun, 13 Mar 2017 3:00 PM+0700'),
  venue: dalat,
...
e = Event.create({
  ...
  starts_at: DateTime.parse('Sat, 16 Mar 2017, 8:00 PM+0700'),
  ends_at: DateTime.parse('Sat, 16 Mar 2017, 10:30 PM+0700'),  
